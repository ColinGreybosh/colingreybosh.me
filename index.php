...
<body>
    ...
    <div class="container">
        <div class="text">
            <p>
                My name is Colin Greybosh, a student at the Hazleton Area Academy of Sciences STEM School and 
                an aspiring programmer/hobbyist web designer from Pennsylvania. I am committed to attending 
                MIT for my freshman year of college in the fall, but I am currently a senior in high school. I 
                am taking classes such as Honors Calculus III and Java II, while I completed courses such as 
                EDSGN 100 with Penn State Hazleton, AP Calculus AB, and Java I.
            </p>
            <p>
