...
<head>
    ...
    <meta http-equiv="refresh" content="0; URL=https://drive.google.com/file/d/1wa4UdMgFaJVtgwTyuILHYe5iAIw05hmW/view?usp=sharing">
...
<body>
  ...
  <div class="container">
    <div class="text" id="education">
      <h2>Education</h2>
      <ul>
        <li>
          <p><span style="font-weight: bold">College:</span> Massachusetts Institute of Technology</p>
          <ul>
            <li><p><span style="font-weight: bold">Classes:</span> Physics I, Calculus I, Principles of Chemical Science,
            The Zen of Probability, Science Writing and New Media: Explorations in Communicating about Science and Technology</p></li>
          </ul>
        </li>
        <li>
          <p><span style="font-weight: bold">High School:</span> Hazleton Area Academy of Sciences, Hazleton Area High School</p>
          <ul>
            <li><p><span style="font-weight: bold">GPA:</span> 100.14</p></li>
            <li><p><span style="font-weight: bold">Classes:</span> Honors Calculus III, Honors Probability & Statistics, Java II, EDSGN 100, AP Calculus AB, Honors Pre-Calculus, Honors Spanish I, II, III, and IV Digital Design/Web Design, Java I</p></li>
          </ul>  
        </li>
      </ul>
    </div>
    ...
    <div class="text" id="awards">
      <h2>Competitions, Clubs, Awards, Extracurricular Activities</h2>
      <ul>
        <li><p>Pennsylvania Junior Academy of Science (5 years)</p>
          <ul>
            <li><p>3 second place awards at Region 2 competition</p></li>
            <li><p>2 first place awards at Region 2 competition</p></li>
            <li><p>1 first place award, perfect score, and excellence recognition award at University Park competition</p></li>
          </ul>
        </li>
        <li>
          <p>Placed in the 99th percentile for the MathCON 2017 competition</p>
          <ul>
            <li><p>23rd nationally in 11th grade at MathCON Chicago</p></li>
          </ul>
        </li>
        <li><p>tecBRIDGE High School Business Plan Competition Semifinalist</p></li>
        <li><p>National Merit Scholarship Commended Student</p></li>
        <li><p>2017 and 2018 University of Scranton Integration Bee</p></li>
        <li><p>National Honor Society</p></li>
        <li><p>Spanish National Honor Society</p></li>
        <li><p>Class of 2018 Executive Council (2 years)</p></li>
        <li><p>National Junior Honor Society (2 years)</p></li>
      </ul>
    </div>

    <div class="text" id="work">
    ...
    <div class="text" id="skills">
      <h2>Skills</h2>
      <ul>
        <li><p>HTML, CSS, and JS for web development</p></li>
        <li><p>Assembling, upgrading, and installing computers</p></li>
        <li><p>C++, Java, and Python programming</p></li>
      </ul>
    </div>
  </div>
