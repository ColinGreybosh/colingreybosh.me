    ...
    <div class="container">
        <div class="text" id="education">
            ...
            <ul>
                ...
                <li><p><span style="font-weight: bold">Completed Classes:</span> EDSGN 100, AP Calculus AB, Honors Pre-Calculus, Honors Spanish I, II, III, and IV Digital Design/Web Design, Java I</p></li>
                <li><p><span style="font-weight: bold">Enrolled Classes:</span> Honors Calculus III, Honors Probability & Statistics, Java II</p></li>
            </ul>
        </div>
        ...
        <div class="text" id="awards">
            ...
            <ul>
                <li>
                    <p>Pennsylvania Junior Academy of Science (5 years)</p>
                    <ul>
